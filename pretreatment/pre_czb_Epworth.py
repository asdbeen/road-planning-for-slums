...
def run_once(blocklist):
    ...
    for original in blocklist:
        ...
        if len(original.interior_parcels) > 0:
            ...
            block_roads = mgh.build_all_roads(block, road_max=1,random_road=False,wholepath=True)
...
if __name__ == "__main__":
    ...
    print("len(g0.inner_facelist)",len(g0.inner_facelist))
    print("len(g0.interior_parcels)",len(g0.interior_parcels))
    print("len(g0.myedges())",len(g0.myedges()))


    print (g0.max_interior_parcels)
    print (g0.build_road_num)
