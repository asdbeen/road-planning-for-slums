...
def GraphFromJSON_Customized_IgnoreShortCut_MultiPOICat(jsonPath,scaleTag = True,rezero=np.array([0, 0]),name="None",new_min = 0,new_max = 2):
    with open(jsonPath, 'r') as file:
        data = json.load(file)
        ptCoordDict = data["ptCoordDict"]
        edgeDict = data["edgeDict"]
        parcelEdgeIDs = data["parcelEdgeIDs"]
        ptIndices_Cat1 = data["ptIndices_Cat1"]
        ptIndices_Cat2 = data["ptIndices_Cat2"]
        ptIndices_Cat3 = data["ptIndices_Cat3"]
